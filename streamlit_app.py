...
try:
    ...
    st.warning("🔄 Server Streamlit sedang memasang pustaka data tambahan (matplotlib/seaborn/scikit-learn).")
    st.info("💡 **Solusi Cepat:** Silakan buka dasbor share.streamlit.io, klik titik tiga (...) di samping nama aplikasi Anda, lalu pilih **Reboot App** agar server memuat ulang file requirements.txt secara paksa.")
